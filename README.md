...
```
python vdjcraft.py -I test.fastq -ref GRCh38.p14.genome.fa -O test -of vdjcraft_test
```
...
```
VDJcraft -I testdata/test.fastq  -ref human_refence.fa(eg.GRCh38.p14.genome.fa) -o test_out -of test_output
```
Or with custom reference genome and filteration cutoff for VJC and D genes:
```
VDJcraft -I vdjcraft/testdata/test.fastq -t2t -p 95 -pd 85 -ref T2T.fa -o test_out -of test_output
```

VDJcraft can be applied with ONT fastq or fasta file with parameter '-ont':
```
VDJcraft -ont testdata/ONT.fastq  -ref human_refence.fa(eg.GRCh38.p14.genome.fa) -o test_out -of test_output
```
...
tes:
```
python vdjcraft.py -I test.fastq -m 80 -ref GRCh38.p14.genome.fa -O test -of vdjcraft_test
```
...
```
python vdjcraft.py -I test.fastq -hg37 -ref GRCh37.genome.fa -O test -of vdjcraft_test
```
...
```
python vdjcraft.py -I test.fastq -R self_generate_IMGT.fa -ref GRCh38.p14.genome.fa -O test -of vdjcraft_test
```

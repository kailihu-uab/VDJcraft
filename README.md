...
tes:
```
./VDJcraft -I test.fastq -m 80 -ref GRCh38.p14.genome.fa -O test -of vdjcraft_test
```
...
```
./VDJcraft -I test.fastq -hg37 -ref GRCh37.genome.fa -O test -of vdjcraft_test
```
...
```
./VDJcraft -I test.fastq -R self_generate_IMGT.fa -ref GRCh38.p14.genome.fa -O test -of vdjcraft_test
```
